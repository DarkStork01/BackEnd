...
<html lang="en">
  ...
  <body class="d-flex align-items-center py-4 bg-body-tertiary">
    <?php require_once 'registerA.php' ?>
    ...
    <main class="form-signin w-100 m-auto">
      <form action="registerA.php" method="post">
        <h1 class="h3 mb-3 fw-normal">Address Registration</h1>
          <div class="col-12">
          ...
          <?php
                if ($_SERVER["REQUEST_METHOD"] == "POST") {
                    ...
                    if($conn-> connect_error) {
                        ...
                        $stmt = $conn->prepare("insert into Address(Country, City, State, PostCode, Street)
                            value(?, ?, ?, ?, ?)");
                        $stmt->bind_param("sssss", $Country, $City, $State, $PostCode, $Street);
